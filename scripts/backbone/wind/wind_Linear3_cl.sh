...
do
  ...
  python -u run_longExp.py \
    ...
    --learning_rate $learning_rate --cl --itr $itr   > logs/backbone/$model_name'_cl_'$data'_'$pred_len'_K'$leader_num'_tau'$tau'_state'$state_num'_lr'$learning_rate.log 2>&1
done
