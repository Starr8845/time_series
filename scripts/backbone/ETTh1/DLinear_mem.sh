...
do
  ...
  python -u run_longExp.py \
    ...
    --tag "_naive" \
    --learning_rate $learning_rate --use_mem > logs/backbone/$model_name'_'$data'_'$pred_len'_K'$leader_num'_tau'$tau'_state'$state_num'_lr'$learning_rate.log 2>&1
done
for pred_len in 96
do
  ...
  python -u run_longExp.py \
    ...
    --leader_num $leader_num --state_num $state_num --temperature $tau \
    --tag "_naive" \
    --learning_rate $learning_rate --use_mem --cl --mem_sele> logs/backbone/$model_name'_'$data'_'$pred_len'_K'$leader_num'_tau'$tau'_state'$state_num'_lr'$learning_rate.log 2>&1
done
for pred_len in 192
do
