...
do
  ...
  python -u run_longExp.py \
    ...
    --learning_rate $learning_rate --backbone --gpu 3 --itr $itr > logs/backbone/$model_name'_'$data'_'$pred_len'_K'$leader_num'_tau'$tau'_state'$state_num'_lr'$learning_rate.log 2>&1
done
for pred_len in 96
do
  leader_num=4
