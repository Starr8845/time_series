...
class Model(nn.Module):
    def __init__(self, configs, max_seq_len:Optional[int]=1024, d_k:Optional[int]=None, d_v:Optional[int]=None, norm:str='BatchNorm', attn_dropout:float=0., 
        ...
        self.model = PatchTST_backbone(c_in=c_in, context_window = context_window, target_window=128, patch_len=patch_len, stride=stride, 
        ...
        # self.final_linear = nn.Linear(128, target_window)
        self.final_linear = nn.Linear(256, target_window)
        self.hid_size = 128
